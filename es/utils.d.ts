...
export declare function addEventListener(target: HTMLElement, eventType: string, callback: (e: React.TouchEvent<HTMLElement> | TouchEvent | Event) => void, options?: any): void;
export declare function removeEventListener(target: HTMLElement, eventType: string, callback: (e: React.TouchEvent<HTMLElement> | TouchEvent | Event) => void, options?: any): void;
