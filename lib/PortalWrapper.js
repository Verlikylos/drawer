...
var _switchScrollingEffect = _interopRequireDefault(require("./utils/switchScrollingEffect"));

var _setStyle = _interopRequireDefault(require("./utils/setStyle"));

var _scrollLocker = _interopRequireDefault(require("./utils/scrollLocker"));
...
var PortalWrapper = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(PortalWrapper, [{
    ...
    value: function render() {
      ...
      if (forceRender || visible || this.componentRef) {
        portal = /*#__PURE__*/React.createElement(_Portal.Portal, {
          getContainer: this.getContainer,
